...
import { updateLead, updateStatus } from '../../actions/leadActions'
...
class UpdateStatus extends Component {
    ...
    onSubmit = (e) => {
        ...
        this.props.updateStatus(id, updatedLead);
        this.handleClose();
    }
...
export default connect(mapStateToProps, { updateStatus, getAgents })(UpdateStatus);